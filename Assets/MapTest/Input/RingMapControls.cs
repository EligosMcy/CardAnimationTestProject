...
//     version 1.19.0
//     from Assets/MapTest/Input/RingMapControls.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/MapTest/Input/RingMapControls.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @RingMapControls: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @RingMapControls()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""RingMapControls"",
    ""maps"": [
        {
            ""name"": ""Map"",
            ""id"": ""5f4a3c2b-1a2b-3c4d-5e6f-7a8b9c0d1e2f"",
            ""actions"": [
                {
                    ""name"": ""LeftClick"",
                    ""type"": ""Button"",
    ...
    ""controlSchemes"": []
        ...
        m_Map_Wheel = m_Map.FindAction("Wheel", throwIfNotFound: true);
    }

    ~@RingMapControls()
    {
        UnityEngine.Debug.Assert(!m_Map.enabled, "This will cause a leak and performance issues, RingMapControls.Map.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Map_Wheel;
    /// <summary>
    /// Provides access to input actions defined in input action map "Map".
    /// </summary>
    public struct MapActions
    {
        private @RingMapControls m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public MapActions(@RingMapControls wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        ...
        /// <summary>
        /// Provides access to the underlying input action "Map/Wheel".
        /// </summary>
        public InputAction @Wheel => m_Wrapper.m_Map_Wheel;
        /// <summary>
